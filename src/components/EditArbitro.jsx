...
export const EditArbitro = ({ arbitroFromGrid, setRefresh, refresh }) => {
  const [arbitro, setArbitro] = useState(arbitroFromGrid);
  //MANIPULACION DE LOS DATOS DEL FORMULARIO
  useEffect(() => {
    async function fetchArbitro() {
      const apiUrl = process.env.REACT_APP_API;

      let fetchedArbitro = await fetch(
